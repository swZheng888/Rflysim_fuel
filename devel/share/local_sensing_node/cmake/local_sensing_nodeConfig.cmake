...
if("TRUE" STREQUAL "TRUE")
  set(local_sensing_node_SOURCE_PREFIX /root/rflysim_fuel_ws/src/FUEL/uav_simulator/local_sensing)
  set(local_sensing_node_DEVEL_PREFIX /root/rflysim_fuel_ws/devel)
  ...
  set(local_sensing_node_INSTALL_PREFIX /root/rflysim_fuel_ws/install)
...
if(NOT "/usr/local/include/opencv4 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'local_sensing_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/rflysim_fuel_ws/src/FUEL/uav_simulator/local_sensing/${idir}'.  ${_report}")
    endif()
    _list_append_unique(local_sensing_node_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/local/lib/libopencv_calib3d.so.4.2.0;/usr/local/lib/libopencv_core.so.4.2.0;/usr/local/lib/libopencv_dnn.so.4.2.0;/usr/local/lib/libopencv_features2d.so.4.2.0;/usr/local/lib/libopencv_flann.so.4.2.0;/usr/local/lib/libopencv_gapi.so.4.2.0;/usr/local/lib/libopencv_highgui.so.4.2.0;/usr/local/lib/libopencv_imgcodecs.so.4.2.0;/usr/local/lib/libopencv_imgproc.so.4.2.0;/usr/local/lib/libopencv_ml.so.4.2.0;/usr/local/lib/libopencv_objdetect.so.4.2.0;/usr/local/lib/libopencv_photo.so.4.2.0;/usr/local/lib/libopencv_stitching.so.4.2.0;/usr/local/lib/libopencv_video.so.4.2.0;/usr/local/lib/libopencv_videoio.so.4.2.0;/usr/local/lib/libopencv_aruco.so.4.2.0;/usr/local/lib/libopencv_bgsegm.so.4.2.0;/usr/local/lib/libopencv_bioinspired.so.4.2.0;/usr/local/lib/libopencv_ccalib.so.4.2.0;/usr/local/lib/libopencv_datasets.so.4.2.0;/usr/local/lib/libopencv_dnn_objdetect.so.4.2.0;/usr/local/lib/libopencv_dnn_superres.so.4.2.0;/usr/local/lib/libopencv_dpm.so.4.2.0;/usr/local/lib/libopencv_face.so.4.2.0;/usr/local/lib/libopencv_freetype.so.4.2.0;/usr/local/lib/libopencv_fuzzy.so.4.2.0;/usr/local/lib/libopencv_hdf.so.4.2.0;/usr/local/lib/libopencv_hfs.so.4.2.0;/usr/local/lib/libopencv_img_hash.so.4.2.0;/usr/local/lib/libopencv_line_descriptor.so.4.2.0;/usr/local/lib/libopencv_optflow.so.4.2.0;/usr/local/lib/libopencv_phase_unwrapping.so.4.2.0;/usr/local/lib/libopencv_plot.so.4.2.0;/usr/local/lib/libopencv_quality.so.4.2.0;/usr/local/lib/libopencv_reg.so.4.2.0;/usr/local/lib/libopencv_rgbd.so.4.2.0;/usr/local/lib/libopencv_saliency.so.4.2.0;/usr/local/lib/libopencv_sfm.so.4.2.0;/usr/local/lib/libopencv_shape.so.4.2.0;/usr/local/lib/libopencv_stereo.so.4.2.0;/usr/local/lib/libopencv_structured_light.so.4.2.0;/usr/local/lib/libopencv_superres.so.4.2.0;/usr/local/lib/libopencv_surface_matching.so.4.2.0;/usr/local/lib/libopencv_text.so.4.2.0;/usr/local/lib/libopencv_tracking.so.4.2.0;/usr/local/lib/libopencv_videostab.so.4.2.0;/usr/local/lib/libopencv_viz.so.4.2.0;/usr/local/lib/libopencv_xfeatures2d.so.4.2.0;/usr/local/lib/libopencv_ximgproc.so.4.2.0;/usr/local/lib/libopencv_xobjdetect.so.4.2.0;/usr/local/lib/libopencv_xphoto.so.4.2.0")
